...
// Adapted from author Justin Either github  - https://github.com/justinethier/AVL-Tree/blob/master/src/main/java/justinethier/AvlTree.java
...
class AvlTree<T extends Comparable<? super T>> {
  /** AvlNode is a container class that is used to store each element (node) of an AVL tree. */
...
// but it needs some attention and does not appear to be 100% correct
  ...
  public static void main () { //String []args){
    ...
    System.out.println( ( (double)(finishm-reference) ));  //in seconds
  }
}
